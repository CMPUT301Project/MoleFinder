...
// BEFORE UI CHOPPING
public class CopyOfMoleFinderActivity extends FActivity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
		...
		case CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE:
			...
			if(resultCode== RESULT_OK){
				...
				Intent intentNewImageActivity = new Intent(CopyOfMoleFinderActivity.this, NewImageActivity.class);
	...
	protected void setClickListeners() {
		...
		buttonReviewImages.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(CopyOfMoleFinderActivity.this, ReviewImagesActivity.class);
	...
	private OnClickListener switchActListener(final Class<?> newAct) {
		return new OnClickListener() {			
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(CopyOfMoleFinderActivity.this, newAct);
				startActivity(intent);
			}
		};
	}
